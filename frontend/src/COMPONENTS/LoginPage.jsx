...
export default function LoginPage() {
    ...
    const [showPassword, setShowPassword] = useState(false); // <-- 1. ADD NEW STATE
            ...
            >
                ...
                <div className="login-header">
                    <div className="flex items-center justify-center">
                        ...
                        <h1 id="login-title" className="login-title">SpeedyFresh</h1>
                    </div>
                    <p className="login-subtitle">Your fresh groceries, delivered fast!</p>
                    <p className="login-welcome-message">Welcome back! Please log in.</p>
                </div>
